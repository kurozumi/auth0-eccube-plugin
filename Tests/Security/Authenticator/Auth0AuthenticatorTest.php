...
class Auth0AuthenticatorTest extends PluginTestCase
{
    ...
    public function setUp()
    {
        ...
        $this->authenticator = new Auth0Authenticator(
            self::$testContainer->get('knpu.oauth2.registry'),
            self::$testContainer->get('doctrine.orm.default_entity_manager'),
            self::$testContainer->get('router')
        );

        $this->router = self::$testContainer->get('router');
        $this->session = self::$testContainer->get('session');

...
class Auth0AuthenticatorTest extends PluginTestCase
{
    ...
    public function setUp()
    {
        ...
        $this->authenticator = new Auth0Authenticator(
            $this->testContainer->get('knpu.oauth2.registry'),
            $this->testContainer->get('doctrine.orm.default_entity_manager'),
            $this->testContainer->get('router')
        );

        $this->router = $this->testContainer->get('router');
        $this->session = $this->testContainer->get('session');
